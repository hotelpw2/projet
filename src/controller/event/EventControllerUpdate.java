...
public class EventControllerUpdate extends HttpServlet{
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException{
		...
		String name=req.getParameter("id");
				...
				for(int i=0;i<events.size();i++) {
					...
					if(iddd.equals(name)) {
						elegido=events.get(i);
						req.setAttribute("events", elegido);
						RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Events/update.jsp");
