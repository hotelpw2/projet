...
public class EventControllerAdd extends HttpServlet{
								...
								if(req.getParameter("action").equals("eventCreate")) {
									...
									if(accesoRolePersonaEncontrada.equals(s1)) {
										...
										dispatcher.forward(req, res);}
											...
											System.out.println("entro con only events view");
											RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/deny.jsp");
											dispatcher.forward(req, res);
										}
								} else
									if(req.getParameter("action").equals("eventCreateDo")) {
