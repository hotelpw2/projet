...
<%Users e = (Users) request.getAttribute("user");%>
<!DOCTYPE html>
<html lang=es>
<head>
...
<body>
	...
	<div class="div2" align="center">
		...
		<input type="text" id="mail" name="mail" class="form-input" value="<%=e.getUserMail()%>" readonly="readonly">
		
		<label for="role" class="form-label">User role:</label>
		<input type="text" id="role" name="role" class="form-input" value="<%=e.getUserRole()%>" readonly="readonly">
		
		<label for="status" class="form-label">User status:</label>
		<input type="text" id="status" name="status" class="form-input" value="<%=e.getUserStatus()%>" readonly="readonly">

		<label for="created" class="form-label">User created:</label>
		<input type="text" id="created" name="created" class="form-input" value="<%=e.getUserCreated()%>" readonly="readonly">
	</form>
	</div>
</body>
</html>