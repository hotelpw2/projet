...
<div id="header">
	...
	<div class="div2" align="center">
		...
		<input type="text" id="mail" name="mail" class="form-input" value="<%= u.getEmail() %>" readonly="readonly">
		<br><br>
		<label for="id" class="form-label">User id: </label>
		<input type="text" id="id" name="id" class="form-input" value="<%= u.getUserId() %>" readonly="readonly">
</form>
</div>
