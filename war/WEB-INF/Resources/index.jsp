...
<body>
	...
	<div class="div2" align="center">
		<form name="miFormulario" class="form" method="get">
		...
		<label for="status" class="form-label">Resource status:</label>
		<input type="text" id="status" name="status" class="form-input" value="<%=e.getResourceStatus()%>" readonly="readonly">
		
		<label for="created" class="form-label">Resource created:</label>
		<input type="text" id="created" name="created" class="form-input" value="<%=e.getResourceCreated()%>" readonly="readonly">
