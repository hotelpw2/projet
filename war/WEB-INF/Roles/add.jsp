...
<body>
	...
	<div class="div2" align="center">
		<form name="miFormulario" class="form" method="get" action="/roles/add" onsubmit="return validar();">
		<input type="hidden" name="action" value="rolesCreateDo"/>
		
		<label for="name" class="form-label">Role Name:</label><br>
		<input type="text" id="name" name="name" class="form-input" placeholder="enter name of the role" required><br><br>
		<input type="submit" class="btn-submit" value="Create role">
		<br><br>
	</form>
	</div>
</body>
