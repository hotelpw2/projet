...
<div class="div2" align="center">
	<table class="table1">
		...
		<tr>
			<td> <%=e.getId()%></td>
			<td> <%=e.getRoleName()%></td>
			<td> <%=e.getRoleStatus()%></td>
			<td> <%=e.getRoleCreated()%></td>
			<td> 
				<a href="/roles/view?id=<%=e.getId()%>">view</a>
			 	<a href="/roles/update?id=<%=e.getId()%>">edit</a>
			 	<a href="/roles/delete?id=<%=e.getId()%>">delete</a>
			</td>
		</tr>
		<%}%>
	</table>
